...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'gender' => ['type' => 'string', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2025-11-18 01:08:26',
                'modified' => '2025-11-18 01:08:26',
            ],
        ];
        parent::init();
    }
